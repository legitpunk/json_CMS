...
$_SESSION['drive_site_dir'] 			=	str_replace($_SESSION['basename_file'], '', $_SERVER["SCRIPT_FILENAME"]);		//example  				C:/wamp/www/LegitPunk.com/templates/file_explorer_iterator/
$_SESSION["site_dir"]						=	str_replace($_SESSION['basename_file'], '', $_SERVER["SCRIPT_NAME"]);				//example           		/LegitPunk.com/templates/file_explorer_iterator/
...
<html>
	...
	<body>
		...
		<header>
			...
			<img class="logo" src="<?= $_SESSION['http_dir']; ?>images/<?= $_SESSION['images_logo']; ?>" class=""></img>
						...
						'change', function() 
						{
							...
							(
								{	
									...
									type: "post",
									url: "<?php echo $_SESSION['http_dir']; ?>config/change_config.php",
